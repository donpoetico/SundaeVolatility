...
## Purpose
Defines the diegetic user interface philosophy, scene architecture, spatial navigation flow, progressive disclosure, and spatial management, ensuring all game information is embedded within the physical shop environment.
